"""Dune Rift - Two Bridges v11 (lobby v8): wet-aware hover walls - v10's blanket
edge-row fence sealed the ENTIRE southern channel (its water became hover island 2,
south pocket island 1; every order in = red no-entry; confirmed on v7-named build,
so no mount ambiguity). v11 closes only DRY edge-row cells within 2 of water (the
actual wet->deck-face climbing step); open water stays open and a new gate asserts
every major water body shares the main hover island (v9 baseline: all island 0).
...
NAME = "[6] Dune Rift - Two Bridges (3v3) v8"   # version IN the lobby name = mount proof; bump EVERY build
